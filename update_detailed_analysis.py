#!/usr/bin/env python3
"""
Script para agregar los estilos CSS y JavaScript para el procedimiento XGBoost animado
"""
...
# CSS y JavaScript a agregar antes del cierre de </style>
css_js_addition = '''
        ...
        .overfitting-tree, .balanced-tree {
            text-align: center;
            padding: 20px;
            border-radius: 12px;
            min-width: 150px;
        ...
        .input-box i, .voting-box i, .output-box i {
            font-size: 2.5rem;
            color: #667eea;
        }
        ...
        @keyframes pulseGlow {
            ...
            50% {
                box-shadow: 0 0 30px #667eea, 0 0 50px #764ba2;
                border-color: #764ba2;
            }
        }
...
# Buscar el marcador para reemplazar
old_marker = '''    <style>
        @keyframes spin {{
...
if old_marker in content:
    content = content.replace(old_marker, css_js_addition)
    ...
    print("✅ Se agregaron los estilos CSS y JavaScript para el procedimiento XGBoost animado")
else:
    print("❌ No se encontró el marcador para reemplazar")
    print("El archivo puede haber sido modificado. Verifica el contenido.")
